...
type ClonesInProgressResp struct {
	ClonesInProgress []string
}

// Note: This will list all in-progress clone jobs across ALL buckets
func (b *Bucket) ListClones(prefix, delim string) (clones *[]string, err error) {
	params := map[string][]string{
		"x-storreduce-clones-in-progress": []string{},
	}
	var resp ClonesInProgressResp
